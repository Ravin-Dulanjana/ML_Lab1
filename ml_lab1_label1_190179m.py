# -*- coding: utf-8 -*-
"""ML_Lab1_Label1_190179M.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1mPfD-4wEEHeLO_rvr2cmCgBhAmDJkypU
"""
...
# Make a copy of the first label of the datasets
trainLabel1Copy = trainLabel1.copy()
validLabel1Copy = validLabel1.copy()
testLabel1Copy = testLabel1.copy()
...
# Train a SVM model
model = SVC()
model.fit(trainFeaturesCopy, trainLabel1Copy)

# Predict on train data
trainPredictionsBase = model.predict(trainFeaturesCopy)
trainDataAccuracy = accuracy_score(trainLabel1Copy, trainPredictionsBase)
trainDataPrecision = precision_score(trainLabel1Copy, trainPredictionsBase, average='weighted' , zero_division=1)
trainDataRecall = recall_score(trainLabel1Copy, trainPredictionsBase, average='weighted')
print("Performance Metrics for SVM on Train Data:")
...
validDataAccuracy = accuracy_score(validLabel1Copy, validPredictionsBase)
validDataPrecision = precision_score(validLabel1Copy, validPredictionsBase, average='weighted', zero_division=1)
validDataRecall = recall_score(validLabel1Copy, validPredictionsBase, average='weighted')
print("Performance Metrics for SVM on Validation Data:")
...
for modelName, model in classificationModels:
    model.fit(pcaTrainResult, trainLabel1)
...
generateCsv(pcaTestResult, testPredictionsBase, predictionTest, '/content/gdrive/MyDrive/Colab Notebooks/ML/Lab1/190179M_label_1.csv')